...
const compareNums = (num1, num2) => {
  if (num1 > num2) {
    ...
    return console.log('Numbers are the same')
}
}
////////////////// PROBLEM 6 ////////////////////
/*
...
let nameGreeting = nameCheck('Derik')
...
//CODE HERE
function caseUpper (a) { 
  return (a.toUpperCase())
}

console.log (caseUpper(sampleString))
////////////////// PROBLEM 18 ////////////////////
/*
...
function emailCheck (email) {
  ...
  let emailTrimmed = emailString.trim()
...
/*
  ...
  you are willing to spend. Your function should return a total amount of chocolate frogs you were able to purchase.
...
/*
 ...
 used in the previous problem (give it the same name, just add a 2 to the end of it) that fixes this bug. Invoke the function and store the returned value to a variable called `totalFrogs2`.
*/
...
/*
  ...
  is in ascending order. The function should return true, if it is sorted in ascending order, false if it is not. Create a variable, 
